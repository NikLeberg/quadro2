...
#define CONTROL_MOTOR_DUTY_MIN_SPIN (0.05f * (CONTROL_MOTOR_DUTY_MAX - CONTROL_MOTOR_DUTY_MIN) + CONTROL_MOTOR_DUTY_MIN)
...
typedef enum {
    ...
    CONTROL_SETTING_THROTTLE_BOOST,
    CONTROL_SETTING_MAX
} control_setting_t;
