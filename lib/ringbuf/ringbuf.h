...
typedef enum {
	...
	/**
	 * Same as byte buffers with one key difference: The xRingbufferSend() takes a
	 * hardware fifo address and reads continously from that address.
	 */
	RINGBUF_TYPE_BYTEBUF_REGISTER_READ
} ringbuf_type_t;
